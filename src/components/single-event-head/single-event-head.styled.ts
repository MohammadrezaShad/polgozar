import { sizes, spacer, colors, fontSize, fontWeight, radius, fontType } from 'settings/style';
...
export const StyledGuestText = styled.span`
  display: inline-flex;
`;
...
export const StyledHeadImgWrap = styled.div`
